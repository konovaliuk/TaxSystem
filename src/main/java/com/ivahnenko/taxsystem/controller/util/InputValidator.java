...
public class InputValidator {
    ...
    private static final String REGEX_TAXPAYER_NAME = "[A-Za-zА-Яа-яsЩЇїІіЄєҐґ0-9«»№@=„/'`:!?,<>)(\"\\*\\-\\s+]{2,320}";
    private static final String REGEX_OWNERSHIP_TYPE = "[A-Z_\\s]{2,20}";
    private static final String REGEX_PERSON_NAME = "[A-Za-z\\s'`-]{2,50}|[А-Яа-яЩЇїІіЄєҐґ\\s'`-]{2,50}";
