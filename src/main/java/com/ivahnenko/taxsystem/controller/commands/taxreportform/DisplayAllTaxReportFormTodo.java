 ...
 * It executes method for displaying all tax report forms with to do status.
 */
public class DisplayAllTaxReportFormTodo implements Command {
    private static final String SUB_COMMAND = "AllTaxReportFormTodo";
    private static final int PAGE_ROWS = 7;
    private static final String STATUS = "TODO";
    ...
    private static final Logger LOGGER = Logger.getLogger(DisplayAllTaxReportFormTodo.class);

    private TaxReportFormService taxReportFormService;

    public DisplayAllTaxReportFormTodo() {
        this.taxReportFormService = ServiceFactoryImpl.getInstance().getTaxReportFormService();
    }

    public DisplayAllTaxReportFormTodo(TaxReportFormService taxReportFormService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        LOGGER.info(String.format("User, id: %d requested DisplayAllTaxReportFormTodo", user.getId()));
        ...
        try {
            ...
            request.setAttribute("taxReportFormList", taxReportFormService.getAllByStatus(STATUS, PAGE_ROWS, offset));
