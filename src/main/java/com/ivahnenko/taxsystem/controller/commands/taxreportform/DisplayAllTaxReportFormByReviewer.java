 ...
 * It executes method for displaying all tax feedback forms of reviewer.
 */
public class DisplayAllTaxReportFormByReviewer implements Command {
    private static final String SUB_COMMAND = "AllTaxReportFormByReviewer";
    private static final int PAGE_ROWS = 7;

    private static final String EXCEPTION_IN_READING_DATA = "exception.dataReading";
    private static final String EXCEPTION_PAGE = "/WEB-INF/exceptionPage.jsp";
    ...
    private static final Logger LOGGER = Logger.getLogger(DisplayAllTaxReportFormByReviewer.class);

    private TaxReportFormService taxReportFormService;

    public DisplayAllTaxReportFormByReviewer() {
        this.taxReportFormService = ServiceFactoryImpl.getInstance().getTaxReportFormService();
    }

    public DisplayAllTaxReportFormByReviewer(TaxReportFormService taxReportFormService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        LOGGER.info(String.format("User, id: %d requested DisplayAllTaxReportFormByReviewer", user.getId()));
        ...
        try {
            ...
            request.setAttribute("taxReportFormList", taxReportFormService.getAllByReviewerId(user.getId(), PAGE_ROWS, offset));
