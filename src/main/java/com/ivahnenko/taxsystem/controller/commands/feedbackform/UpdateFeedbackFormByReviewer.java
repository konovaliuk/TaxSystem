 ...
 * It executes method for updating feedback form details by reviewer.
 */
public class UpdateFeedbackFormByReviewer implements Command {
    ...
    private static final String VALIDATION_EXCEPTION_PAGE = "/main/displayFeedbackFormDetailsByReviewer";
    private static final String EXCEPTION_PAGE = "/WEB-INF/pages/exceptionPage.jsp";

    private static final Logger LOGGER = Logger.getLogger(UpdateFeedbackFormByReviewer.class);
    ...
    public UpdateFeedbackFormByReviewer() {
        this.feedbackFormService = ServiceFactoryImpl.getInstance().getFeedbackFormService();
    }

    public UpdateFeedbackFormByReviewer(FeedbackFormService feedbackFormService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        LOGGER.info(String.format("User, id: %d requested UpdateFeedbackFormByReviewer", user.getId()));
        ...
        try {
            ...
            feedbackFormParams.put(REVIEWER_COMMENT, reviewerComment);
            ...
            boolean actionSuccess = feedbackFormService.updateByReviewerAndStatus(feedbackForm, ALLOWED_STATUS_TO_MAKE_UPDATE);
