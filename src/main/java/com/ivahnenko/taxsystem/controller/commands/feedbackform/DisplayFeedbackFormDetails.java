 ...
 * It executes method for displaying feedback form detailed information.
 */
public class DisplayFeedbackFormDetails implements Command {
    ...
    private static final Logger LOGGER = Logger.getLogger(DisplayFeedbackFormDetails.class);

    private FeedbackFormService feedbackFormService;

    public DisplayFeedbackFormDetails() {
        this.feedbackFormService = ServiceFactoryImpl.getInstance().getFeedbackFormService();
    }

    public DisplayFeedbackFormDetails(FeedbackFormService feedbackFormService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        LOGGER.info(String.format("User, id: %d requested DisplayFeedbackFormDetails", user.getId()));

        try {
            int feedbackFormId = Integer.parseInt(request.getParameter(ENTITY_NAME));
            Optional<FeedbackForm> optionalFeedbackForm = feedbackFormService.getById(feedbackFormId);
