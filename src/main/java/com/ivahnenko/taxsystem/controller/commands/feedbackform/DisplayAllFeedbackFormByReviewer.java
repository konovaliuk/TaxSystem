 ...
 */
public class DisplayAllFeedbackFormByReviewer implements Command {
    private static final int PAGE_ROWS = 7;
    private static final String SUB_COMMAND = "AllFeedbackFormByReviewer";
    ...
    private static final Logger LOGGER = Logger.getLogger(DisplayAllFeedbackFormByReviewer.class);

    private FeedbackFormService feedbackFormService;

    public DisplayAllFeedbackFormByReviewer() {
        this.feedbackFormService = ServiceFactoryImpl.getInstance().getFeedbackFormService();
    }

    public DisplayAllFeedbackFormByReviewer(FeedbackFormService feedbackFormService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        LOGGER.info(String.format("User, id: %d requested DisplayAllFeedbackFormByReviewer", user.getId()));
        ...
        try {
            ...
            request.setAttribute("feedbackFormList", feedbackFormService.getAllByReviewerId(user.getId(), PAGE_ROWS, offset));
